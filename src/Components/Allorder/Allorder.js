            ...
            <tr>
                ...
                <td>{address}</td>
                {
                    (status === "pending") ?
                        <>
                            <td>{status}</td>
                            <td><button className="fw-bold btn btn-dark">Accept</button> / <button onClick={() => props.handelDeleteOrder(_id)} className="text-primary border-0" ><i class="fas fa-trash-alt"></i></button></td></>
                        :
                        <>
